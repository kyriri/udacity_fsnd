...
def upgrade():
    ...
    op.execute("INSERT INTO venues (id, name, city, state, address, phone, website, seeking_talent) VALUES (2, 'Teatro Colón', 'Buenos Aires', 'CABA', 'Cerrito 628', '+54 11 4378 7100', 'https://www.teatrocolon.org.ar/', False)")
    op.execute("INSERT INTO venues (id, name, address, website, phone, seeking_talent) VALUES (3, 'Cirque du Soleil', 'itinerant', 'https://www.cirquedusoleil.com/', '+1 877 924 7783', False)")
